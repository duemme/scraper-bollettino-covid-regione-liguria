...
url = 'https://www.regione.liguria.it/homepage/salute-e-sociale/homepage-coronavirus/bollettino-coronavirus/dati-21-5-2021.html'
r = requests.get(url)
soup = BeautifulSoup(r.text, 'html.parser')

tables = []
for table in soup.find_all('table', {'style': re.compile(r'width: 99%.*')}):
    tables.append(table)
