...
day = 18
r = requests.get(f'https://www.regione.liguria.it/homepage/salute-e-sociale/homepage-coronavirus/bollettino-coronavirus/dati-{day}-4-2021.html')
...
for i in range(7,76,4):
    ...
    ospedalizzati[table_2_values[i].replace(' ','_')][table_2_values[0].replace(' ','_')] = int(table_2_values[i+1].replace('.',''))
    ospedalizzati[table_2_values[i].replace(' ','_')][table_2_values[1].replace(' ','_')] = int(table_2_values[i+2].replace('.',''))
    ospedalizzati[table_2_values[i].replace(' ','_')][table_2_values[2].replace(' ','_')] = int(table_2_values[i+3].replace('.',''))
...
print(tamponi,casi_provincia,ospedalizzati,isolamento_domiciliare,guariti,deceduti,dettaglio_deceduti,sorveglianze_attive)
